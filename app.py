...
COURSE_OPTIONS = [
    {
        "id": "1",
        "local": "SALÃO DE FESTAS DO GOVERNARDOR IATE CLUBE",
        "curso": "TODOS OS RITMOS",
        "turma": "ESPECIAL DIA DAS MÃES",
        "dias_aula": "Sábado",
        "horario": "09h",
        "data_inicio": "09/05/2026",
        "encerramento": "⚠️Em caso de chuva pode ser cancelado",
        "endereco_curso": "📍Salão de Festas do Governardor Iate Clube - Tauá, Rua Praia da Rosa, 1350 RJ",
    },
]
        ...
        <div class="wizard-shell">
            <form id="wizard-form" method="POST" action="{{ url_for('inscricao_unica') }}" autocomplete="off" novalidate>
                <section class="wizard-panel" data-step="index">
                    <div class="hero-grid">
                        <div class="hero-card">
                                <span class="hero-pill">PROJETO:<br>DANÇANDO NA PRAÇA</span>
                                <h1 class="hero-title">AULÃO DE DANÇA, ESPECIAL DIA DAS MÃES!</h1>
                                <p class="hero-subtitle">
                                    Evento Gratuito:<br>
                                    Celebre o dia das mães dançando e compartilhando um momento especial<br>
                                    📍Salão de Festas do Governardor Iate Clube - Tauá, Rua Praia da Rosa, 1350 RJ
                                </p>
